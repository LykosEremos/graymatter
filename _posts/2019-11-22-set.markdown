...
\end{align*}
$$
<p>称 $(a,b)$ 为<span class='concept'>有序对</span>，称 $(a,b,c)$ 为 3维有序数组. </p>
上述定义的集合都存在.
</div>
...
作为练习，让我们试着证明 “$n$维有序数组是有定义的.” 这一断言对全体自然数 $n$ 都成立. 
<ul>
...
经典组合数学（combinatorics）研究的一部分内容就是用有创意的方法，证明一些有限集合大小的计算方法. 例如，我们可以研究从不相交的集合 $A$ 和 $B$ 中各抽一个元素出来，有几种抽法，而这个问题要求的就是笛卡尔积 $A\times B$ 的势，$\|A\times B\|$. 我们在组合数学的章节里会回到这个话题上来.
