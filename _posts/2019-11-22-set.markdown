...
(a,b)&=((a),b)=\{\{\{\varnothing\}, \{\varnothing,a\}\}\}, \{\{\{\varnothing\}, \{\varnothing,a\}\},b\}\}\\
(a,b,c)&=((a,b),c)\\
\end{align*}
$$
...
$$A \cap \bigcup \mathcal{C} =\bigcup_{C\in \mathcal{C}} A\cap C\qquad \qquad A \cup \bigcap \mathcal{D} = \bigcap_{D\in \mathcal{D}} A\cup D$$
</li>
<li>补的德摩根律
$$B - \bigcup \mathcal{A} = \bigcap_{A\in \mathcal{A}} B -A\qquad \qquad B - \bigcap \mathcal{A} = \bigcup_{A \in \mathcal{A}}B - A$$
</li>
<li>子集的性质
<ol>
