...
这篇文章是APG IV词源标注项目的一个纲要性的词法参考，不是完整的拉丁语语法教程。市面上正式的拉丁语语法书已经够多了，我要是把其中的内容再复述一遍，也只不过是老调重弹，和大面积的复制黏贴无异，而《植物学拉丁语》在词法上的讨论又普遍太浅（不论是国内还是国外的书都这样。其实入门级别的拉丁语课本在这方面也没好到哪去）。这篇文章的目的即是以简要而严谨的方式，讨论一些在植物学名词源辨析、释义的过程中必备的语言知识，并解释一些我在正文中使用的语言术语和缩写。

对程序员来说，好的代码必须简洁（simple）、可读（legible）、健壮（robust）。我在编写这篇文章的时候也参考了类似的标准。我在保留了充要的词法知识的前提下举了很多简单易记的例子，使用了大量的简写（一段话中连续出现几次“第一人称单数直陈语气主动态现在时”这么长的词语想必会严重影响阅读断句），并且尽可能多地考虑各种各样可以被视为“例外”的情况，为实际工作中可能出现的疑问提供解答，避免过度简化。我很注重学术写作中的原创性，因此本文中出现的例子基本都是我自己找的，很多都和生物学有关，这也反映了拉丁词源的知识在生物学各个分支的学习中都有应用的价值。

请注意：

* 这篇文章可能会有一些错字笔误。
* 这篇文章并不是终版。我觉得有持续更新这篇文章的必要，可能还会再写几个章节。以后有机会做动物的词源标注工作的时候也会补上一些ICZN的规定。
...
<a name="正写系统"></a>
<h1 class="hd">正写系统</h1>
古典拉丁语的字母表是不含 j，u，w 的英语26个字母。j 是中世纪发明用来区分元音 i 和辅音 i 的。同样，v 表示辅音 u，而 w 是日耳曼语中来的，本质上是连体的两个 v。发展中的拉丁语和所有的自然语言一样，其语音和正写上的规则是动态的，不少字母的发音和拼法都经历了变化。因此，不论是林奈的时代还是21世纪，二名法中使用的拉丁语都不是古典时期的拉丁语，它吸收了大量来自其他语言的词汇，并且 j，u，w 也在不同的时期被引入了字母表（在裸子植物中就可以随手找到两个例子，<i>Juniperus</i> 和 <i>Welwitschia</i>）。所以，如今为人所知的拉丁字母（Latin alphabet）就是26字母。

国际植物命名法规（ICBN，下简称“命名法规”）第60.6条规定，学名中变体的拉丁字母必须被转写成一般的拉丁字母。这些变体包括德语中含元音变音符（umlaut）的 ä，ö，ü，拉丁字母中古体的连体双元音 æ 和 œ，法语、西班牙语中的各种尖、钝音符、抑扬符等，都得转写为合适的拉丁形式。分音符（diaeresis）是允许存在的，因此 Isoëtales“水韭目”的拼法不算错。

更多ICBN制定的正写规则请见ICBN第9章第一部分。
<a name="发音"></a>
<h1 class="hd">发音</h1>
目前，物种学名的发音尚未被标准化，而我个人倾向于使用 Allen（1978）在 <i>Vox Latina</i> 中复原的所谓黄金时代（罗马共和国晚期－罗马帝国早期）的古典拉丁语读音。如果你看过我做的纪录片系列，就会发现我大部分情况下都按这套规则发音。科研社区内还有两种常见的读法，即把拉丁语当英语读的英语式读法，和当代天主教教廷使用的那种意大利语式（Italianate）的读法。在没有统一的国际标准且学术交流主要依靠书面沟通的情况下，分类学学者不用在读音方面费太多心思，做到准确地让听者知道自己描述的是什么物种即可。
...
* 音量（quantity）是一个音节的内在性质，是用“轻”（light）和“重”（heavy）来描述的。长元音所在的音节一定是重读，而重读音节的元音可长可短，这是因为含短元音的音节轻重取决于该音节的开闭情况（即是以辅音结尾还是以元音结尾）及其后跟随的辅音的种类。元音长度和音量这两个概念往往互相混淆，这是因为在很多语法书上，称因含长元音或双元音（双元音在长度上等同于一个长元音）而重读的音节为“long by nature”，含短元音但因音节开闭情况而重读的音节为“long by position”。Allen（1973）和Allen（1977）都就这种历史悠久的术语混用作了详细的讨论。梵语的语言学上对元音长度和音量有清晰的区分，因此“轻”和“重”作为梵语语言学术语लघु和गुरु的意译在描述音量时使用，避免混用。
...
* 
拉丁语的诗歌往往是有诗韵（meter）的。诗人会有意地根据诗韵，通过调换一行诗中的词语顺序来调整轻、重读音节的位置，使其组成一组规律排布的音步（foot）。一个音步是几个音节组合形成的，比如一个重读音节和两个轻读音节依次排列组成一个强弱弱步（dactyl），两个重读音节组成一个强强步（spondee）。拉丁史诗中常见的强弱弱六步格（dactylic hexameter），就要求一行诗必须由四个强弱弱步或强强步开头（任意排列组合），以一个强弱弱步作第五音步，以一个强弱弱步或强强步结尾，共六个音步。有时语言学家会通过已知的诗韵，划分音步，倒回去求音节的轻、重读规律。这种方法的问题在于。虽然语言学上有古代语法家的证词和诸如拉赫曼定律（Lachmann's law）的语言学规律，这些隐藏音量（hidden quantity）往往是不能确定的（indeterminate）。
...
为了统一术语的定义，我想在这个章节的最后谈谈三个语言学上的概念：词干、词基和词根。
