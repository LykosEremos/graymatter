...
layout: post
title:  "词法参考"
date:   2017-04-28 22:31:19 -0400
categories: resources
---
<a name="写在前面的话"></a>
<h1 class="hd">写在前面的话</h1>

这篇文章是APG IV词源标注项目的一个纲要性的词法参考，不是完整的拉丁语语法教程。市面上正式的拉丁语语法书已经够多了，我要是把其中的内容再复述一遍，也只不过是老调重弹，和大面积的复制黏贴无异，而《植物学拉丁语》在词法上的讨论又普遍太浅。这篇文章的目的即是以简要而严谨的方式，讨论一些在植物学名词源辨析、释义的过程中必备的语言知识，并解释一些我在正文中使用的语言术语和缩写。

对程序员来说，好的代码必须简洁（simple）、可读（legible）、健壮（robust）。我编写这篇文章时也参考了类似的标准。我在保留了充要的词法知识的前提下举了很多简单易记的例子，使用了大量的简写（一段话中连续出现几次“第一人称单数直陈语气主动态现在时”这么长的词语想必会很难断句），并尽可能多地考虑各种各样可以被视为“例外”的情况，为实际工作中可能出现的疑问提供解答，避免过度简化。我很注重学术写作中的原创性，因此本文中的例子基本都是我自己找的，很多都和生物学有关，这也反映了拉丁词源的知识在生物学的各个分支中都有应用的价值。

请注意：

* 文中我不会回答一些很基础的问题（例如什么是辅音，什么是主语，什么是分词），所以本文的读者应具备一定的基础知识。
* 这篇文章中的 “正文”指APG IV词源标注项目的主要文本。

<a name="正写系统"></a>
<h1 class="hd">正写系统</h1>
用最简单的话来说，古典拉丁语的字母表就是不含 j，u，w 的英语26个字母。j 是中世纪发明用来区分元音 i 和辅音 i 的，v 表示辅音 u，而 w 则来自于日耳曼语，本质上是连体的双写v。发展中的拉丁语和所有的自然语言一样，其语音和正写上的规则是动态的，不少字母的发音和拼法都经历了变化。因此，不论是林奈的时代还是21世纪，二名法中使用的拉丁语都已不是古典时期的拉丁语了。它吸收了大量来自其他语言的词汇，在不同的时期将 j，u，w 引入了字母表（在裸子植物中就可以随手找到两个例子，<i>Juniperus</i> 和 <i>Welwitschia</i>）。正因如此，如今为人所知的拉丁字母（Latin alphabet）指的就是这26个字母。

国际植物命名法规（ICBN，下简称“命名法规”）第60.6条规定，学名中变体的拉丁字母必须被转写成一般的拉丁字母。这些变体包括德语中含元音变音符（umlaut）的 ä，ö，ü，拉丁字母中古体的连体双元音 æ 和 œ，法语、西班牙语中的各种尖、钝音符、抑扬符等，都得转写为合适的拉丁形式（<a name="icbn" href="#icbns">McNeill et al. 2012</a>）。分音符（diaeresis）是允许存在的，因此 Isoëtales“水韭目”的拼法不算错。

更多ICBN规定的正写规则请参见ICBN第9章第一部分。
<a name="发音"></a>
<h1 class="hd">发音</h1>
目前，物种学名的发音尚未被标准化，而我个人倾向于使用 <a name="allen1978" href="#allen1978s">Allen（1978）</a> 在 <i>Vox Latina</i> 中复原的所谓黄金时代（罗马共和国晚期－罗马帝国早期）的古典拉丁语读音。如果你看过我做的纪录片系列，就会发现我大部分情况下都按这套规则发音。科研社区内还有两种常见的读法，即把拉丁语当英语读的英语式读法，和当代天主教教廷使用的那种意大利语式（Italianate）的读法。在没有统一的国际标准且学术交流主要依靠书面沟通的情况下，分类学学者不用在读音方面费太多心思，做到准确地让听者知道自己描述的是什么物种即可。
...
<ul class="paradigm"><li>sg. nom.</li><li>sg. gen.</li><li>词性</li><li>“词意”</li> </ul>
...
动词在词典中给出的形式一般是
<ul class="paradigm"><li>1st. sg. act. pres. ind.</li><li>pres. inf.</li><li>1st. sg. act. pres. perf.</li><li>PPP</li><li>“词意”</li></ul>
这是因为：
...
* 有些时候指小形式的形成并不那么规则。罗马诗人卡图卢斯的诗集 <i>Libellus</i>“小书”是 liber, libri, m.“小书”的指小形式，但不是从词基或词干衍生来的，而是 lib-ellus。认知科学的课本上有时可以见到的 “皮质矮人”（cortical homunculus）比喻中的 homunculus“矮人”来自 homo, hominis, m.“人”，它的形成也不规则。
...
* 单从前缀的形态来推测其词源发展的细节有时是困难和不准确的。in- 在比较早期的拉丁语中，由同义的 endo- 和 indu /i- 表现，这个前缀是来自于意义相同，形态也相近的的希腊语前缀 ένδο-（内吞作用 endocytosis 是一个希腊语词，其前缀就是希腊语的 ένδο-，而不是拉丁语的 endo-），还是仅和其同源，还是独立形成但又受希腊语借词影响，还是有争议的（<a name="devaan" href="#devaans">de Vaan 2008</a>）。
...
<h1 class="hd">参考文献</h1>
<ul class="citation">
<li><a href="#allen1973" name="allen1973s">Allen, W. S. (1973). Accent and rhythm: Prosodic features of Latin and Greek : a study in theory and reconstruction.</a></li>
<li><a href="#allen1978" name="allen1978s">Allen, W. S. (1978). Vox Latina: A guide to the pronunciation of classical Latin (2nd ed.). Cambridge: Cambridge University Press.</a></li>
...
<li><a href="#icbn" name="icbns">McNeill, J., Barrie, F. R., Buck, W. R., Demoulin, V., Greuter, W., Hawksworth, D. L., . . . Turland, N. J. (Eds.). (2012). International code of nomenclature for algae, fungi, and plants: (Melbourne code) ; adopted by the eighteenth International Botanical Congress, Melbourne, Australia, July 2011. Königstein: Koeltz Scientific Books.</a></li>
